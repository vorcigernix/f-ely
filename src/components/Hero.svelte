<section>
	<div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
		<div class="flex flex-wrap items-center mx-auto max-w-7xl">
			...
			>
				<span class="mb-8 text-xs font-bold tracking-widest uppercase">
					Včelař Ondra
				</span>
				<h1
					class="mb-8 text-4xl font-bold leading-none tracking-tighter  md:text-7xl lg:text-5xl"
				>
					Horský med. Zdravý, od spokojených včel.
				</h1>
				<p class="mb-8 text-base leading-relaxed text-left text-hurricane-800">
					Moje včely sbírají pyl z horských luk a lesů a všechno hodnotné ukládají do svého medu.
					Nikdy jste nejedli lepší.
				</p>
